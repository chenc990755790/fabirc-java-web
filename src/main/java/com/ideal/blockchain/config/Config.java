...
public class Config {
    ...
    private Config(String path) {
        ...
        try {
            ...
            sdkProperties.load(new FileInputStream(PATH + "/" + path));
...
//				}
                ...
                if (true) {
                    String cert = "artifacts/kafka/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem"
